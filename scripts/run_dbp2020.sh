...
docker run -m 50GB -d --name $container -e "JAVA_TOOL_OPTIONS=-Xmx30g" --mount type=bind,source=/srv/data/iq26og/data/,target=/app/data --mount type=bind,source=/srv/data/iq26og/git/KG2PG/,target=/app/local $image /app/local/config/dbpedia2020.properties
