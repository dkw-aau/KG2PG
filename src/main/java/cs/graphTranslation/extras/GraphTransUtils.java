...
//
//import static cs.utils.Constants.GEOSPARQL_NS;
//import static cs.utils.Constants.WKTLITERAL;
...
//
///**
// * This class overrides methods from RDFToLPGStatementProcessor class of n10s project
// */
//public class GraphTransUtils {
//    public final RDFParserConfig parserConfig;
//
...
//    //public final n10s.graphconfig.RDFParserConfig parserConfig;
//    private final Map<String, String> vocMappings;
//    public GraphDatabaseService graphdb;
//    public NsPrefixMap namespaces;
//    public Set<Statement> statements = new HashSet<>();
//    public Map<String, Map<String, Object>> resourceProps = new HashMap<>();
//    public Map<Statement, Map<String, Object>> relProps = new HashMap<>();
//    public Map<String, Set<String>> resourceLabels = new HashMap<>();
...
//    public StringBuilder loadWarnings = new StringBuilder();
//    public boolean datatypeConflictFound = false;
//
//    public GraphTransUtils(RDFParserConfig parserConfig) {
//        this.parserConfig = parserConfig;
//        this.vocMappings = new HashMap<>();
//    }
//
//    /**
...
//     */
//    public Object getObjectValue(IRI propertyIRI, Literal object) {
...
//                        parserConfig.getGraphConf().isKeepLangTag() && language.isPresent() ? "@" + language.get() : "");
//            } else {
//                //filtered by lang
//                return null;
//            }
...
//                    parserConfig.getGraphConf().getHandleVocabUris() == GRAPHCONF_VOC_URI_IGNORE || parserConfig.getGraphConf().getHandleVocabUris() == GRAPHCONF_VOC_URI_MAP)) {
...
//    }
//
//    public String getValueWithDatatype(IRI datatype, String value) {
...
//    }
//
//    public String handleIRI(IRI iri, int elementType) {
...
//        totalTriplesParsed++;
//
////        if (!parserConfig.isUseSingleTx() && parserConfig.getCommitSize() != Long.MAX_VALUE && mappedTripleCounter != 0 && mappedTripleCounter % parserConfig.getCommitSize() == 0) {
////            periodicOperation();
////        }
//    }
//
...
//    }
//
//    public boolean setProp(String subjectUri, IRI propertyIRI, Literal propValueRaw) {
...
//    }
//
//    public boolean addRelProp(Statement stmt, IRI predicate, Literal propValueRaw){
//
//        Map<String, Object> props;
...
//        }
//    }
//    public void setLabel(String subjectUri, String label) {
//        Set<String> labels;
//
//        if (!resourceLabels.containsKey(subjectUri)) {
//            initialiseResourceProps(resourceProps,subjectUri);
